...
- `admin`: explicit reserved local-maintenance profile. In this phase it does not expose cleanup execution, agent/API execution, HTTP/socket transport, shell tools, external upload, profile reuse, provider credentials, or arbitrary process control.
