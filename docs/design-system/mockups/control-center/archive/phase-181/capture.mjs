...
const captures = [
  ...
  { name: 'mock-new-review-ai-change-desktop.png', screen: 'new', ai: 'change', effort: 'high', viewport: { width: 1440, height: 1000 } },
  ...
  { name: 'mock-settings-ai-change-desktop.png', screen: 'settings', ai: 'change', effort: 'high', viewport: { width: 1440, height: 1000 } },
