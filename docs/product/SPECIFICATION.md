...
- `agentic review report-quality --result <path> --json` reads local advisory results and returns completeness, evidence coverage, verification coverage, and warnings with no provider calls, writes, or gate changes.
