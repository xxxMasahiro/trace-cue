...
- Treat target runtime readiness findings as consumer application state until proven otherwise. Check the consumer app's full local stack and API base settings before treating API 404s or `needs_attention` as Browser Debug CLI connection failures.
