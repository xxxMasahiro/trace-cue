...
const schemas = Object.freeze({
  ...
  agentic_human_review_proposal: Object.freeze({
    ...
    type: 'object',
    required: ['schema_version', 'proposal_version', 'type', 'id', 'status', 'created_at', 'proposal_path', 'proposal_hash', 'source_request', 'structured_intent', 'plan_candidate', 'human_explanation', 'review_effort', 'sub_agents', 'transfer_preview', 'provider', 'model', 'surface', 'next_commands', 'approval', 'boundary', 'gate_effect'],
    properties: {
      schema_version: { type: 'string' },
  ...
  agentic_human_review_report_quality: Object.freeze({
    ...
    type: 'object',
    required: ['schema_version', 'type', 'generated_at', 'result_path', 'completeness_score', 'evidence_coverage_score', 'verification_score', 'advisory_only', 'gate_effect', 'boundary'],
    properties: {
      schema_version: { type: 'string' },
  ...
  agentic_human_review_plan: Object.freeze({
    ...
    type: 'object',
    required: ['schema_version', 'plan_version', 'type', 'id', 'status', 'created_at', 'plan_path', 'package_path', 'package_hash', 'plan_hash', 'human_explanation', 'review_effort', 'default_subagent_effort', 'sub_agents', 'transfer_permissions', 'disclosure', 'provider', 'model', 'surface', 'rubric', 'approval', 'execution', 'result_contract', 'gate_effect', 'boundary'],
    properties: {
      schema_version: { type: 'string' },
  ...
  agentic_human_review_package: Object.freeze({
    ...
    type: 'object',
    required: ['schema_version', 'package_version', 'package_kind', 'id', 'created_at', 'package_path', 'task', 'source', 'visual_evidence', 'content_evidence', 'semantic_evidence', 'artifact_references', 'existing_review_state', 'disclosure', 'boundary'],
    properties: {
      schema_version: { type: 'string' },
  ...
  human_review_rubric: Object.freeze({
    ...
    type: 'object',
    required: ['schema_version', 'rubric_version', 'output_schema', 'areas', 'confidence_model', 'advisory_only', 'gate_effect'],
    properties: {
      schema_version: { type: 'string' },
  ...
  agentic_human_review_advisory: Object.freeze({
    ...
    type: 'object',
    required: ['schema_version', 'id', 'result_type', 'agentic_human_review_advisory', 'non_engineer_summary', 'subjective_perception', 'readability_comprehension', 'role_opinions', 'consensus_summary', 'dissent_summary', 'agentic_human_review_findings', 'agentic_human_review_action_plan', 'agentic_human_review_readiness', 'owner_decision_requests', 'provider', 'model', 'transfer_permissions', 'execution', 'boundary'],
    properties: {
      schema_version: { type: 'string' },
      id: { type: 'string' },
